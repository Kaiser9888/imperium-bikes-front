...
export const NAV_ITEMS = [
    ...
    { icon: Play, label: "Longos", href: "/videos/longos" },
    { icon: Clapperboard, label: "Memento", href: "/videos/memento" },
    { icon: Plus, label: "Publicar", href: "/videos/upload", highlight: true },
    { icon: Search, label: "Buscar", href: "/videos/buscar" },
    { icon: User, label: "Perfil", href: "/videos/perfil" },
];
    ...
    return (
        <header className="sticky top-0 z-50 hidden border-b border-border bg-background/80 backdrop-blur-md lg:block">
            <div className="mx-auto flex h-16 max-w-7xl items-center justify-between gap-8 px-6">
                <Link href="/videos" className="flex items-baseline gap-3">
