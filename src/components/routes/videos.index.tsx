...
import { EmptyState, ErrorState } from "@/components/videos/FeedStates";
import { DEFAULT_CATEGORY } from "@/lib/videos/categories";

export const Route = createFileRoute("/videos/")({
    head: () => ({
        meta: [
            { title: "Vídeos — Imperium Bikes" },
            { name: "description", content: "Trilhas, tutoriais e reviews de ciclismo publicados pela comunidade Imperium Bikes." },
            { property: "og:title", content: "Vídeos — Imperium Bikes" },
            { property: "og:description", content: "Trilhas, tutoriais e reviews de ciclismo da comunidade Imperium Bikes." },
        ],
    }),
    ...
    return (
        <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 lg:py-10">
            <header className="mb-6 lg:hidden">
                ...
                <p className="text-[10px] uppercase tracking-[0.35em] text-muted-foreground">Vídeos</p>
            </header>
                ...
                {loading ? (
                    ...
                    <>
                        ...
                        <div aria-live="polite" className="sr-only">
                            {loadingMore ? "Carregando mais vídeos" : `${visible.length} vídeos carregados`}
                        </div>
