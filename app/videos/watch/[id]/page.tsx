          ...
          <div className="grid gap-6 lg:gap-8 lg:grid-cols-[minmax(0,1fr)_360px]">
              <div className="space-y-4 lg:space-y-5">
                  ...
                  <button
                    ...
                    className="mx-4 sm:mx-0 flex w-full items-center rounded-lg border border-border bg-card px-2 py-4 text-sm font-medium text-muted-foreground hover:text-foreground hover:border-primary/30 transition-colors"
                  >
                      Comentários
                  </button>
