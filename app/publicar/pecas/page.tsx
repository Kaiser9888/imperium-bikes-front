...
const PECA_CATEGORIES = [
  { id: "transmissao", label: "Transmissão", description: "Câmbios, cassetes, correntes", icon: Cog, image: "/images/categories/modalidades/transmissao.jpg" },
  { id: "freios", label: "Freios", description: "Pinças, discos, manetes", icon: Disc, image: "/images/categories/modalidades/freios.jpg" },
  { id: "suspensao", label: "Suspensão", description: "Garfos e amortecedores", icon: Wrench, image: "/images/categories/modalidades/suspensao.jpg" },
  { id: "eletrica", label: "Elétrica", description: "Baterias, motores", icon: Zap, image: "/images/categories/modalidades/eletrica.jpg" },
  { id: "protecao", label: "Proteção", description: "Capacetes, luvas, óculos", icon: Shield, image: "/images/categories/modalidades/protecao.jpg" },
  { id: "cabos", label: "Cabos e Conduítes", description: "Cabos, conduítes, capas", icon: Cable, image: "/images/categories/modalidades/cabos.jpg" },
  { id: "quadro", label: "Quadro", description: "Quadros e peças estruturais", icon: Bike, image: "/images/categories/modalidades/quadro.jpg" },
  { id: "rodas", label: "Rodas e Pneus", description: "Aros, cubos, pneus", icon: CircleDot, image: "/images/categories/modalidades/rodas.jpg" },
  { id: "instrumentos", label: "Instrumentos", description: "Ciclocomputadores, GPS", icon: Gauge, image: "/images/categories/modalidades/instrumentos.jpg" },
] as const

type PecaCategoryId = (typeof PECA_CATEGORIES)[number]["id"]

const TIPOS_BY_CATEGORY: Record<PecaCategoryId, readonly string[]> = {
  transmissao: ["Câmbio Dianteiro", "Câmbio Traseiro", "Cassete", "Corrente", "Pedivela", "Passador", "Movimento Central"],
  freios: ["Pinça de Freio", "Disco de Freio", "Manete", "Pastilhas", "Kit Freio Completo"],
  suspensao: ["Garfo Rígido", "Suspensão Dianteira", "Amortecedor Traseiro", "Canote Retrátil"],
  eletrica: ["Bateria", "Motor", "Display", "Sensor", "Carregador"],
  protecao: ["Capacete", "Luva", "Óculos", "Joelheira", "Cotoveleira"],
  cabos: ["Cabo de Freio", "Cabo de Marcha", "Conduíte", "Capa de Cabo"],
  quadro: ["Quadro MTB", "Quadro Speed", "Quadro Gravel", "Quadro BMX"],
  rodas: ["Aro", "Cubo", "Pneu", "Câmara de Ar", "Roda Completa", "Raio"],
  instrumentos: ["Ciclocomputador", "GPS", "Sensor de Cadência", "Sensor Cardíaco"],
}
