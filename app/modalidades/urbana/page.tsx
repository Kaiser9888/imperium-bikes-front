...
export default function UrbanaPage() {
        ...
        <div className="min-h-screen bg-background">
            ...
            <section className="relative h-[60vh] min-h-[400px] overflow-hidden">
                <video
                    ...
                    poster="/images/urbana-poster.png"
                >
                    <source src="/videos/urbana-hero.mp4" type="video/mp4" />
                </video>
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 md:p-10">
                    ...
                    <p className="mt-2 max-w-xl text-sm text-background/80 md:text-base">
                        Mobilidade com estilo. As bikes urbanas são feitas para o dia a dia, unindo conforto, praticidade e design para a vida na cidade.
                    </p>
                </div>
            </section>
            ...
            <section className="mx-auto max-w-3xl px-4 py-10">
                <h2 className="font-heading text-lg font-bold uppercase tracking-wide text-foreground">
                    A Origem da Bike Urbana
                </h2>
                <div className="mt-4 space-y-4 text-sm leading-relaxed text-muted-foreground">
                    <p>
                        A bicicleta urbana tem suas raízes no século XIX, com a invenção do pedal. Mas foi no início do século XX que ela
                        se popularizou como meio de transporte nas cidades europeias, especialmente na Holanda e Dinamarca. Após a Segunda
                        Guerra Mundial, com a reconstrução das cidades, as bicicletas se tornaram o principal veículo da classe trabalhadora.
                    </p>
                    <p>
                        Copenhague e Amsterdã lideraram a revolução das bikes urbanas. Na Holanda, o movimento <strong className="text-foreground">Stop de Kindermoord</strong>
                        (Pare o Assassinato de Crianças) nos anos 1970 protestou contra as mortes no trânsito e pressionou por infraestrutura
                        cicloviária. O resultado foi a criação da maior rede de ciclovias do mundo e uma cultura onde 36% dos deslocamentos
                        são feitos de bicicleta.
                    </p>
                    <p>
                        Hoje, as bikes urbanas evoluíram para atender diferentes estilos: as clássicas holandesas com quadro step-through,
                        as fixas de pista adaptadas para a rua, as dobráveis para transporte multimodal e as elétricas que vencem ladeiras
                        sem esforço. Marcas como <strong className="text-foreground">Gazelle</strong>, <strong className="text-foreground">Brompton</strong> e
                        <strong className="text-foreground"> VanMoof</strong> definem o design contemporâneo.
                    </p>
                </div>
            </section>
